...
//   setNewProduct({...newProduct,[e.target.id]:e.target.value,dampingRate:0.8})
//       }
...
const postProduct=async (newProduct)=>{
  ...
  return (
       ...
       <form onSubmit={handleSubmit} className="row justify-content-center align-items-center p-5 border m-3 bg-light w-50 h-50">
        <div className=" mb-3">
        ...
        <div className=" mb-3">
          <div htmlFor="price" className="text-start mb-2">
            Product Price
          </div>
          <input onChange={(e)=>setPrice(Number(e.target.value))} type="number" className="form-control" id="price" required 
          value={price} />
        </div>
        <div className=" mb-3">
        ...
        <button className="btn btn-success w-25 mt-4"><FaCartPlus size={25}/> Add To Cart</button>
      </form> 
